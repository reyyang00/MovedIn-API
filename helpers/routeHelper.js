...
module.exports = {
    ...
    schemas: {
        ...
        roomSchema: Joi.object().keys({
            ...
            price_range: Joi.string().required().allow('', null),
            gender_prefered: Joi.string().required().allow('', null),
            room_type: Joi.string().required().allow('', null),
            city: Joi.string().required(),
            utility_include: Joi.string().required().allow('', null),
            cooking: Joi.string().required().allow('', null),
            pet: Joi.string().required().allow('', null),
            party: Joi.string().required().allow('', null),
            smoking: Joi.string().required().allow('', null),
            parking: Joi.string().required().allow('', null),
            furniture: Joi.string().required().allow('', null),
            bathroom: Joi.string().required().allow('', null),
            min_lease_duration: Joi.string().required().allow('', null),
            move_in_date: Joi.string().required().allow('', null),
